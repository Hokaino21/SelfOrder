        ...
        <div class="tracking-card">
            ...
            <div class="order-info">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value" style="text-transform: uppercase;"><?php echo e($order->status); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Total:</span>
                    <span class="info-value">Rp <?php echo e(number_format($order->total_price, 0, ',', '.')); ?></span>
                </div>
            </div>

            <!-- Status Timeline -->
            <div class="status-timeline">
                <div class="timeline-item <?php echo e(in_array($order->status, ['pending', 'preparing', 'ready', 'completed']) ? 'completed' : ''); ?>">
                    <div class="timeline-dot">✓</div>
                    <div class="timeline-line"></div>
                    <div class="timeline-content">
                        <div class="timeline-title">Pesanan Diterima</div>
                        <div class="timeline-description"><?php echo e($order->ordered_at->format('d/m/Y H:i')); ?></div>
                    </div>
                </div>

                <div class="timeline-item <?php echo e($order->status === 'pending' ? 'active' : ($order->status === 'preparing' || $order->status === 'ready' || $order->status === 'completed' ? 'completed' : '')); ?>">
                ...
                <div class="timeline-item <?php echo e($order->status === 'preparing' ? 'active' : ($order->status === 'ready' || $order->status === 'completed' ? 'completed' : '')); ?>">
                    <div class="timeline-dot">🍽️</div>
                    <div class="timeline-line"></div>
                    <div class="timeline-content">
                ...
                <div class="timeline-item <?php echo e($order->status === 'ready' ? 'active' : ($order->status === 'completed' ? 'completed' : '')); ?>">
                    <div class="timeline-dot">✨</div>
                    <div class="timeline-line"></div>
                    <div class="timeline-content">
                ...
                <div class="timeline-item <?php echo e($order->status === 'completed' ? 'active' : ''); ?>">
                    ...
                    <div class="timeline-content">
                        ...
                        <div class="timeline-description"><?php echo e($order->completed_at ? $order->completed_at->format('d/m/Y H:i') : 'Menunggu pengambilan'); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="order-items">
                ...
                <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="order-item">
                        <div><?php echo e($item->menuItem->name); ?></div>
                        <div class="item-qty"><?php echo e($item->quantity); ?>x</div>
                        <div class="item-price">Rp <?php echo e(number_format($item->price * $item->quantity, 0, ',', '.')); ?></div>
                    </div>
            ...
            <div class="action-buttons">
                ...
                <button class="home-btn" onclick="window.location.href='<?php echo e(route('menu.index')); ?>'">← Kembali</button>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\c7\resources\views/order/track.blade.php ENDPATH**/ ?>