...
<body>
    <div class="container">
        <div class="form-card">
            ...
            <form id="orderForm" method="POST" action="<?php echo e(route('order.store')); ?>" onsubmit="prepareForm(event)">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\c7\resources\views/order/create.blade.php ENDPATH**/ ?>