...
<body>
    <div class="container">
        <div class="receipt">
            ...
            <div class="receipt-header">
                ...
                <div class="receipt-title"><?php echo e($order->status === 'ready' ? 'Pembayaran Berhasil' : 'Pesanan Berhasil Dibuat'); ?></div>
                <div class="receipt-subtitle"><?php echo e($order->status === 'ready' ? 'Pembayaran Anda telah diverifikasi' : 'Pesanan Anda telah diterima'); ?></div>
                <div>
                    <span class="status-badge status-<?php echo e($order->status); ?>">
                        <?php if($order->status == 'pending'): ?> ⏳ Menunggu Pembayaran
                        <?php elseif($order->status == 'preparing'): ?> 👨‍🍳 Sedang Diproses
                        <?php elseif($order->status == 'ready'): ?> ✓ Pembayaran Diterima
            ...
            <div class="receipt-section">
                ...
                <div class="receipt-row">
                    ...
                    <span class="receipt-value"><?php echo e($order->customer_name); ?></span>
                </div>
                <?php if($order->customer_phone): ?>
                <div class="receipt-row">
                    <span class="receipt-label">Telepon</span>
                    <span class="receipt-value"><?php echo e($order->customer_phone); ?></span>
                </div>
                <?php endif; ?>
                <div class="receipt-row">
                    <span class="receipt-label">Waktu Pesan</span>
                    <span class="receipt-value"><?php echo e($order->ordered_at ? $order->ordered_at->format('d/m/Y H:i') : $order->created_at->format('d/m/Y H:i')); ?></span>
                </div>
            </div>
            ...
            <div class="receipt-section">
                ...
                <div class="items-list">
                    ...
                    <div class="item-row">
                        <span class="item-name"><?php echo e($item->menuItem->name ?? 'Menu Tidak Ditemukan'); ?></span>
            ...
            <div class="receipt-section">
                ...
                <div style="color: #666; line-height: 1.5;"><?php echo e($order->notes); ?></div>
            </div>
            <?php endif; ?>
            ...
            <div class="receipt-section">
                ...
                <div class="receipt-row">
                    ...
                    <span class="receipt-value">
                        <?php if($order->payment_method == 'cash'): ?> Tunai
                        <?php elseif($order->payment_method == 'bank_transfer'): ?> Transfer Bank
                        <?php elseif($order->payment_method == 'ewallet'): ?> Dompet Digital
                        <?php endif; ?>
                    </span>
                </div>
                <div class="receipt-row">
            ...
            <div class="action-buttons">
                <a href="<?php echo e(route('order.payment', $order->id)); ?>" class="btn btn-primary">💳 Lanjut Pembayaran</a>
                <a href="<?php echo e(route('order.track', $order->order_number)); ?>" class="btn btn-primary">📍 Tracking Pesanan</a>
            </div>
            <?php else: ?>
            <div class="action-buttons">
                <a href="<?php echo e(route('order.history')); ?>" class="btn btn-primary">📜 Riwayat Transaksi</a>
                <a href="<?php echo e(route('order.track', $order->order_number)); ?>" class="btn btn-primary">📍 Tracking Pesanan</a>
            </div>
            <?php endif; ?>
            ...
            <div class="action-buttons">
                ...
                <a href="<?php echo e(route('menu.index')); ?>" class="btn btn-secondary">← Kembali Menu</a>
            </div>
    ...
    <script>
        ...
        <?php if(session('success')): ?>
            Swal.fire({
                title: '✅ <?php echo e(addslashes(session('success'))); ?>',
                icon: 'success',
...
<?php /**PATH C:\laragon\www\c7\resources\views/order/receipt.blade.php ENDPATH**/ ?>