...
<body>
    <?php
        $fallbackImages = [
            ...
            'Bakso Goreng' => asset('images/menu/bakso-goreng.svg'),
    ...
    <div class="container">
        <div class="topbar">
            ...
            <a href="<?php echo e(route('admin.login')); ?>" class="admin-btn">Admin</a>
        </div>
            ...
            <section class="menu-panel">
                <div class="controls-section">
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-buttons">
                            <button class="filter-btn <?php echo e($category === 'all' ? 'active' : ''); ?>" onclick="filterMenu('all')">Semua</button>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button class="filter-btn <?php echo e($category === $cat ? 'active' : ''); ?>" onclick="filterMenu(<?php echo \Illuminate\Support\Js::from($cat)->toHtml() ?>)"><?php echo e($cat); ?></button>
                ...
                <div class="menu-grid" id="menuGrid">
                    <?php $__empty_1 = true; $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <article class="menu-card" data-name="<?php echo e(strtolower($item->name)); ?>" data-category="<?php echo e($item->category); ?>">
                            <div class="menu-image">
                                <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($item->name); ?>" loading="lazy" data-fallback="<?php echo e($categoryImages[$item->category] ?? $categoryImages['Makanan Berat']); ?>" onerror="this.onerror=null; this.src=this.dataset.fallback;">
                                <span class="category-pill"><?php echo e($item->category); ?></span>
                            </div>
                            <div class="menu-content">
                                <div class="menu-name"><?php echo e($item->name); ?></div>
                                <div class="menu-description"><?php echo e($item->description); ?></div>
                                <div class="menu-footer">
                                    <span class="menu-price">Rp <?php echo e(number_format($item->price, 0, ',', '.')); ?></span>
                                    <button class="add-btn" onclick="addToCart(<?php echo e($item->id); ?>, <?php echo \Illuminate\Support\Js::from($item->name)->toHtml() ?>, <?php echo e($item->price); ?>)">Tambah</button>
                                </div>
                            </div>
                        </article>
...
<?php /**PATH C:\laragon\www\c7\resources\views/menu/index.blade.php ENDPATH**/ ?>