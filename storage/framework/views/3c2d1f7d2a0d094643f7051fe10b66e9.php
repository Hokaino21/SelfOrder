    ...
    <div class="container">
        ...
        <div class="controls-section">
            ...
            <div class="filter-section">
                ...
                <div class="filter-buttons">
                    <button class="filter-btn <?php echo e($category === 'all' ? 'active' : ''); ?>" onclick="filterMenu('all')">
                        Semua
                    </button>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button class="filter-btn <?php echo e($category === $cat ? 'active' : ''); ?>" onclick="filterMenu('<?php echo e($cat); ?>')">
                            <?php echo e($cat); ?>
        ...
        <div class="menu-grid" id="menuGrid">
            <?php $__empty_1 = true; $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="menu-card" data-name="<?php echo e(strtolower($item->name)); ?>" data-category="<?php echo e($item->category); ?>">
                    ...
                    <div class="menu-content">
                        ...
                        <div class="menu-footer">
                            ...
                            <button class="add-btn" onclick="addToCart(<?php echo e($item->id); ?>, '<?php echo e($item->name); ?>', <?php echo e($item->price); ?>, event)">
                                + Tambah
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        let allMenuItems = [
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                { id: <?php echo e($item->id); ?>, name: '<?php echo e($item->name); ?>', category: '<?php echo e($item->category); ?>' },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
